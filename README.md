...
## Testing
Unit tests were written to support the development of the MessageHandler, Encoder, and Decoder classes. 
The Google Test framework was used for this, but as some refactoring was done after the tests were written, they are not currently functional.
